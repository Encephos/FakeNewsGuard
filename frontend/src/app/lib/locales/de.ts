const de = {
  ...
  admin: {
    ...
    evaluation: {
      ...
      verdictAccuracy: "Verdict-Genauigkeit",
      verdictWithinOneStep: "Innerhalb 1 Stufe",
      expectedVerdict: "Erwartet",
      predictedVerdict: "Vorhergesagt",
      verdictAccuracyReport: "Verdict-Accuracy",
