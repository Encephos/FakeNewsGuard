const en = {
  ...
  admin: {
    ...
    evaluation: {
      ...
      sampleSize: "Number of Test Cases",
      ...
      passed: "Passed",
      failed: "Failed",
      preferredDomainHitRate: "Domain Hit Rate",
      lowTrustRate: "Low Trust Rate",
      directEvidenceRate: "Direct Evidence",
      offtopicRate: "Off-topic Rate",
      sourceDiversity: "Source Diversity",
      freshnessHitRate: "Freshness",
      verdictAccuracy: "Verdict Accuracy",
      verdictWithinOneStep: "Within 1 Step",
