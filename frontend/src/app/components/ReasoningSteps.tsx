...
export default function ReasoningSteps({ steps, isActive }: ReasoningStepsProps) {
  ...
  return (
    <div className="w-full mb-5 rounded-xl border border-border overflow-hidden animate-fade-in" style={{ boxShadow: "var(--shadow)" }}>
      {/* Status bar */}
      <div className="flex items-center gap-2.5 px-4 py-2.5 border-b border-border bg-bg-tertiary">
      ...
      {/* Log */}
      <div className="px-4 py-3 max-h-52 overflow-y-auto space-y-0.5 font-mono text-[11.5px] bg-surface">
        {steps.map((step, i) => (
