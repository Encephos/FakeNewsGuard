"""Web-Search-Abstraktionsschicht – unterstützt SearXNG, LangSearch, Tavily, Serper, Brave.

Primäre Suchquellen für den EvidenceBuilderAgent:
  - SearXNG    (self-hosted, breite Abdeckung)
  - LangSearch (semantische Websuche, parallele Quelle)
...
from config import LangSearchConfig, RetryConfig, SearchConfig
