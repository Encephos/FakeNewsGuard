...
def minimal_config():
    return AppConfig(
        ...
        search=SearchConfig(provider="mock"),
...
def mock_search_client(mocker):
    client = mocker.MagicMock(spec=AsyncWebSearchClient)
...
def sample_claims():
    return [
        Claim(id=1, text="Die Erde ist rund.", type=ClaimType.FACTUAL, context=""),
        Claim(id=2, text="GDP wuchs um 2%.", type=ClaimType.STATISTICAL, context=""),
    ]
```
